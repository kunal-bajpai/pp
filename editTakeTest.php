 ...
 <div id='mininav' class='wrap3'>
	...
	<div id='wrapper'>
		<div id='editPicsPreview'>
		   <?php
			...
			<div id='imgBox' class='selectable imgBox' data-selected='0' >
				<div id='imgThumb' class='imgThumb' style='background-image:url(<?php echo "pictures/tests/thumbs/".$testFile;?>)' data-pic='<?php echo $testFile;?>'></div>
				...
				<div><?php echo $testFile;?></div>
			</div>
			<div id='imgBox' class='imgBox'>
				<div id='imgThumb' class='edited imgThumb' style='background-image:url(<?php echo "pictures/editors/editor".$editor->id."/thumbs/".$testFile;?>)' data-pic='<?php echo $testFile;?>'></div>
			</div>
		...
		<div id='photoModal1' class='photoModal'>
			...
			<div id='prevPic12' class='modalImg2'></div>
