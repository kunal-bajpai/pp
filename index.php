 ...
 <!-- Bootstrap -->
  ...
  <div>
	...
	<div class="hex col-sm-6  templatemo-hex-top3">
		...
		<div>
		  <div class="hexagon hexagon2 ">
			<div class="hexagon-in1">
			  <div class="hexagon-in3" style="background-image: url(images/gallery/a.png); background-color:#3399cc;">
	 ...
	 <div class="hex col-sm-6 templatemo-hex-top1 templatemo-hex-top3">
		<div>
		  <div class="hexagon hexagon2 ">
			<div class="hexagon-in1">
			  <div class="hexagon-in3" style="background-image: url(images/gallery/b.png); background-color:#73bf2d;">
	  ...
	  <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top3">
		<div>
		  <div class="hexagon hexagon2 ">
			<div class="hexagon-in1">
			  <div class="hexagon-in3" style="background-image: url(images/gallery/c.png); background-color:#3399cc;">
	  ...
	  <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top2">
		<div>
		  <div class="hexagon hexagon2 gallery-item">
			<div class="hexagon-in1">
			  <div class="hexagon-in3" style="background-image: url(images/gallery/d.png); background-color:#73bf2d;">
	...
	<div class="container">
		...
		<button  onclick="location.href = './editHome.php';" class="proceed gallery_more2 round-corners">Proceed&#x2192;</button>
	</div>
	</div>
